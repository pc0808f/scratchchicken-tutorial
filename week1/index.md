...
- ✅ **學會換造型顏色**：用填色桶幫角色換上喜歡的顏色
- ✅ **掌握事件概念**：理解「當綠旗被點擊」的程式觸發機制
- ✅ **操作基本積木**：讓角色移動、旋轉和說話

### 🎨 創意目標
- 🌟 **擁有自己的雞**：換顏色、取名字，讓牠成為獨一無二的「你的雞」
- 🌟 **連結真實經驗**：把 Scratch 裡的雞和你在雞舍認養的那隻雞連結起來
- 🌟 **發揮個人創意**：加入自己的創意元素和特色

> 💡 家和背景我們**下週**再做，這週先把雞顧好、讓牠動起來就好！
...
超酷的角色設計，我們留到以後慢慢玩。今天用最快的方法，讓每個人 10 分鐘內都有一隻「自己的雞」！
...
1. 點上方的 **「造型」** 頁籤
2. 選擇填色桶工具
3. 點雞身上的某個部位，換成你喜歡的顏色（想換好幾個地方也可以！）
...
<div class="color-scheme neutral">
<h5>🎨 中性色調</h5>
<p>米色 + 棕色 + 灰色</p>
</div>
...
#### 🏷️ 步驟三：取你的雞的名字
1. 在角色區找到雞的名稱欄位
2. 把名字改成**你在雞舍認養的那隻雞的名字**
3. 這樣你的 Scratch 雞和真實世界的雞就是同一隻了！

🎉 **完成！你已經有一隻獨一無二、顏色不一樣、名字不一樣的雞了！**

### 🎬 第三步：讓你的雞動起來

現在幫你的雞寫第一個程式，讓牠會動、會說話：
...
🎉 **恭喜！你的雞不只有自己的顏色和名字，現在還會動、會說話了！**

<div class="alert alert-info">
🏠 <strong>家和背景，我們下週再做！</strong> 今天先讓雞活起來就好，不用急。
</div>
...
#### 挑戰1：多造型設計
- 看看 hen 內建有幾種造型，試試「下一個造型」積木

#### 挑戰2：把貓咪刪掉
- 舞台上如果還有預設的貓咪，試著把牠刪掉，讓舞台只有你的雞
...
下週我們將學習：
- **背景設計**：畫出雞舍或喜歡的場景，當作雞的家
- **場景佈置**：用繪圖工具加上細節
- **角色搭配**：讓雞和背景放在一起更好看

### 🐔 本週還有：戶外雞舍任務

別忘了今天也要去看看你認養的那隻雞！觀察牠、記住牠的樣子和習慣，這些都會變成之後做 Scratch 雞的靈感。

### 🏠 本週回家任務（可選）

1. **觀察你的雞**：牠今天做了什麼？跟平常一樣嗎？
2. **收集靈感**：想想牠的家可以長什麼樣子（下週要用）
3. **分享作品**：和家人分享今天做的雞
...
**Q: 找不到 hen 這個角色怎麼辦？**  
A: 確認你點的是「選擇角色」而不是「繪製」，搜尋欄打 hen 就會出現一整排雞的圖案，選一隻你喜歡的都可以。

**Q: 填色桶點下去顏色沒有變怎麼辦？**  
A: 要點在造型的線條「裡面」，如果那個區域沒有完全封閉，顏色會漏出去，可以請老師或同學幫忙看看。
...
- **[背景設計範例](./scratch_examples/03_background_examples.md)**：下週會用到
