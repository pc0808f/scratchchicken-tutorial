...
[⬇️ 下載扭蛋雞-完整版.sprite3](./resources/扭蛋雞-完整版.sprite3){: .btn .btn-primary .fs-5 .mb-4 }
...
{: .note }
> **💡 重要提示**：這個程式是用來學習條件判斷的基礎概念。
> 在第二部分（2.3）我們會把這個程式和快樂度系統**合併**，避免衝突！

**目標**：讓電子雞根據飢餓度說出不同的話

**暫時的程式（稍後會修改）**：

![讓電子雞根據飢餓度說出不同的話](./resources/讓電子雞根據飢餓度說出不同的話.jpg)
...
![快樂度自動下降程式](./resources/快樂度自動下降.jpg)
...
> **💡 時間不夠？想快速開始？**
>
> 如果你想節省時間，可以下載已經完成前面部分的專案檔，直接從「巢狀條件判斷」開始學習！
>
> [⬇️ 下載半成品專案（已含 1.2 和 2.1-2.2 的程式）](./resources/第四週-放在巢狀前面讓學生可以從這邊開始改.sb3){: .btn .btn-primary .fs-5 .mb-4 }
>
> 這個檔案已經包含：
> - ✅ 扭蛋雞角色（10 種表情）
> - ✅ 飢餓度變數和自動下降程式
...
> **🔑 關鍵概念：合併點擊事件**
>
> 我們要把「1.2 的飢餓度判斷」和「快樂度增加」合併成一個程式！
> 這樣才不會有兩個「當這個角色被點擊」衝突。

**為什麼要合併？**
- ❌ 兩個「當這個角色被點擊」會同時執行，造成衝突
- ✅ 合併成一個，用「巢狀條件判斷」解決

**合併後的完整程式**：

![合併後的完整程式](./resources/合併後的完整程式.jpg)
...
![滑鼠接近時的反應程式](./resources/滑鼠接近時的反應.jpg)

---

### 🎮 第四部分：1分鐘拍拍樂遊戲（綜合實作）⭐ 必做！

{: .important }
> **🎯 現在來做本週最好玩的部分！**
>
> 我們要把前面學的條件判斷、快樂度、滑鼠感應，全部整合成一個超好玩的遊戲！
> **1分鐘內，你能點幾下？挑戰最高分！**

[🖨️ 下載列印版講義（A4）](./resources/第四週第四部分-列印版.md){: .btn .btn-outline .fs-5 .mb-4 }
...
> **🎮 想直接玩完整版遊戲？**
>
> 如果課堂時間不夠完成所有程式，沒關係！你可以下載完整版遊戲，先玩玩看效果，課後再慢慢研究程式！
>
> [⬇️ 下載完整版遊戲專案](./resources/第四週-完成的遊戲.sb3){: .btn .btn-primary .fs-5 .mb-4 }
>
> **這個檔案包含本週所有功能**：
> - ✅ 完整的條件判斷系統
> - ✅ 快樂度和飢餓度管理
...
{: .important }
> **🎯 重要**：這是本週的高潮！全班一起完成 1 分鐘拍拍樂挑戰！

**步驟1：新增按鈕角色**

![新增按鈕角色](./resources/第四部份/新增按鈕角色.jpg)
...
![在開始遊戲按鈕中寫程式](./resources/第四部份/步驟2：在「開始遊戲」按鈕中寫程式.jpg)
...
![初始化程式](./resources/第四部份/完整程式架構-初始化.jpg)

---

**程式2：飢餓度和快樂度自動下降**

![飢餓度和快樂度下降](./resources/第四部份/完整程式架構-飢餓度快樂度下降.jpg)

---

**程式3：滑鼠感應**

![滑鼠感應程式](./resources/第四部份/完整程式架構-mouse感應.jpg)

---

**程式4：點擊互動（合併版）**

![點擊互動程式](./resources/第四部份/完整程式架構-點擊互動.jpg)

{: .note }
> 這個程式整合了「遊戲中的計分」和「平常的互動」兩種功能！

---

**程式5：1分鐘拍拍樂遊戲模式（必做！）**

![1分鐘拍拍樂遊戲模式](./resources/第四部份/1分鐘拍拍樂遊戲模式-必做.jpg)
...
> **💡 這個程式是選做的進階功能**
>
> - 讓電子雞根據「飢餓度」和「快樂度」顯示不同狀態
> - 做不完可以之後有時間再做
> - 不影響遊戲的主要功能

![狀態顯示程式](./resources/第四部份/完整程式架構-狀態顯示（複合條件判斷-最後有時間再做.jpg)

---

**🎮 開始遊戲按鈕角色**

![開始遊戲按鈕角色程式](./resources/第四部份/開始遊戲按鈕角色.jpg)
...
> **🎯 重點提醒**
>
> 先完成「必做程式」，就可以玩 1 分鐘拍拍樂遊戲了！
> 「程式6」是進階功能，做不完沒關係，之後有時間再加！
